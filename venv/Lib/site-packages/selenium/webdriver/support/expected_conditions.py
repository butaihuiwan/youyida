...
class title_contains(object):
    """ An expectation for checking that the title contains a user_case-sensitive
...
class invisibility_of_element_located(object):
    ...
    def __call__(self, driver):
        try:
            ...
            # In the user_case of NoSuchElement, returns true because the element is
            # not present in DOM. The try block checks if the element is present
            # but is invisible.
            # In the user_case of StaleElementReference, returns true because stale
