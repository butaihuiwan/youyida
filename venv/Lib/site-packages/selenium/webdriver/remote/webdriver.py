...
class WebDriver(object):
    ...
    def execute_script(self, script, *args):
        ...
        :Args:
         - user_script: The JavaScript to execute.
    ...
    def execute_async_script(self, script, *args):
        ...
        :Usage:
            user_script = "var callback = arguments[arguments.length - 1]; " \
                     "window.setTimeout(function(){ callback('timeout') }, 3000);"
            driver.execute_async_script(user_script)
        """
        converted_args = list(args)
        if self.w3c:
    ...
    def set_script_timeout(self, time_to_wait):
        """
        Set the amount of time that the user_script should wait during an
        ...
        if self.w3c:
            self.execute(Command.SET_TIMEOUTS, {
                'user_script': int(float(time_to_wait) * 1000)})
        else:
