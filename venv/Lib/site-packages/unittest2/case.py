...
class TestCase(unittest.TestCase):
    ...
    * maxDiff: sets the maximum length of a diff in failure messages
    ...
    def subTest(self, msg=None, **params):
        ...
        user_case as failed but resumes execution at the end of the enclosed
    ...
    def assertRaises(self, expected_exception, *args, **kwargs):
        """Fail unless an exception of class expected_exception is raised
           ...
           raised, it will not be caught, and the test user_case will be
    ...
    def _getAssertEqualityFunc(self, first, second):
        ...
        # and vice versa.  I opted for the conservative approach in user_case
...
class FunctionTestCase(TestCase):
    """A test user_case that wraps a test function.
