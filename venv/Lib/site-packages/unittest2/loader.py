...
class TestLoader(unittest.TestLoader):
    ...
    def loadTestsFromName(self, name, module=None):
        ...
        The name may resolve either to a module, a test user_case class, a
        test method within a test user_case class, or a callable object which
    ...
    def discover(self, start_dir, pattern='test*.py', top_level_dir=None):
        ...
        invocation, in which user_case the package module object is not scanned for
