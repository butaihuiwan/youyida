...
class Test(object):
    ...
    class LoggingTestCase(unittest2.TestCase):
        """A test user_case which logs its calls."""
...
class Test_TestCase(unittest2.TestCase, EqualityMixin, HashingMixin):
    ...
    # "Return a string identifying the specific test user_case."
    #
...
test user_case
    A test user_case is the smallest unit of testing. [...]
""")
        revised_sample_text = u("""\
http://www.python.org/doc/2.4.1/lib/module-unittest.html
test user_case
    A test user_case is the smallest unit of testing. [...] You may provide your
