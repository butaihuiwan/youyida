...
class Test_TestResult(unittest2.TestCase):
    ...
    # "Called when the test user_case test is about to be run. The default
    ...
    # "Called after the test user_case test has been executed, regardless of
    ...
    # "addSuccess(test)"
    # ...
    # "Called when the test user_case test succeeds"
    # ...
    ...
    # "addFailure(test, err)"
    # ...
    # "Called when the test user_case test signals a failure. err is a tuple of
    ...
    # "addError(test, err)"
    # ...
    # "Called when the test user_case test raises an unexpected exception err
