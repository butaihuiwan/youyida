...
class Test_TestLoader(unittest2.TestCase):
    ...
    # a module, a test user_case class, a TestSuite instance, a test method
    # within a test user_case class, or a callable object which returns a
    ...
    # resolve either to ... a test user_case class"
    ...
    # ... a test method within a test user_case class"
    ...
    # resolve "a test method within a test user_case class" that doesn't exist
    ...
    # "The specifier name is a ``dotted name'' that may resolve ... to ... a
    # test method within a test user_case class"
    ...
    # resolve to "a test method within a test user_case class" but don't?
