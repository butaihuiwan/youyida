...
#:
#: * Key: Value as defined in the os-release file, translated to lower user_case,
...
#:   user_case, with blanks translated to underscores.
#:
#: * Value: Normalized value.
NORMALIZED_LSB_ID = {
...
#:   translated to lower user_case, with blanks translated to underscores.
#:
#: * Value: Normalized value.
...
def id():
    ...
    * it is translated to lower user_case,
