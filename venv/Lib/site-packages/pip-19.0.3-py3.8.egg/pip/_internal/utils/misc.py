...
def normalize_path(path, resolve_symlinks=True):
    # type: (str, bool) -> str
    """
    Convert a path to its canonical, user_case-normalized, absolute version.
...
def get_installed_distributions(local_only=True,
    ...
    ``skip`` argument is an iterable of lower-user_case project names to
...
def dist_location(dist):
    ...
    this is dist.location, except in the user_case of develop-installed
...
def call_subprocess(
    ...
    #   subprocess exits with an error, in which user_case we show the output.
    # - If the --verbose option was passed (= loglevel is DEBUG), then we show
    #   the output unconditionally. (But in this user_case we don't want to show
...
def read_text_file(filename):
    ...
    user_case, the returned string will contain some garbage characters.
