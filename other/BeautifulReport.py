...
class PATH:
    """ all file PATH meta """
    # config_tmp_path = SITE_PAKAGE_PATH + r'\BeautifulReport\template\template'
    config_tmp_path = r'C:\Users\wh\PycharmProjects\youyida\venv\Lib\site-packages\BeautifulReport\template\template'
...
class BeautifulReport(ReportTestResult, PATH):
    ...
    def output_report(self):
        ...
        with open(template_path, 'rb') as file:
            ...
            print('....', override_path)
            print('******', self.filename)
            override_path = 'C:\\Users\\wh\\PycharmProjects\\youyida\\report\\'
    ...
    def img2base(img_path: str, file_name: str) -> str:
        ...
        # TODO
        img_path = r'C:\Users\wh\PycharmProjects\youyida\suit\image' + '\\'
            ...
            def __wrap(*args, **kwargs):
                ...
                try:
                    ...
                    if 'save_img' in dir(args[0]):
                        ...
                        data = BeautifulReport.img2base(img_path, func.__name__ + '.png')
